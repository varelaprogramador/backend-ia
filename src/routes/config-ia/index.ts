      ...
      schema: {
        ...
        body: {
          ...
          properties: {
            ...
            rdstationClientId: { type: "string" },
            rdstationClientSecret: { type: "string" },
            rdstationAccessToken: { type: "string" },
            rdstationRefreshToken: { type: "string" },
            rdstationCode: { type: "string" },
